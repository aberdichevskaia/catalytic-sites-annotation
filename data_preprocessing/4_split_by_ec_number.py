...
def process_chains(seq_id, relevant_chains, protein_info, set_type, set_mapping, component_mapping):
...
def save_annotations(data, output_file):
    """Save annotations dict to a text file."""
...
def main():
    ...
    final_dataset_path   = args.output_csv
    ...
    for seq_id, record in protein_data.items():
        ...
        if relevant_chains:
            process_chains(seq_id, relevant_chains, record, set_type, set_mapping, component_mapping)
        ...
        for pdb_id in pdb_ids:
            ...
            if relevant_chains_pdb:
                process_chains(pdb_id, relevant_chains_pdb, record, set_type, set_mapping, component_mapping)
